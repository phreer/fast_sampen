...
char usage[] =
    ...
    "simple\n"
    "                        or multirecord. If set to simple, then each line "
    "of the\n"
    ...
    "    The number of computations for mean and variance of the sampling "
    "methods.\n"
    "--sample-size-array N01,N02,N03,N0n\n"
    "    An array of sample sizes (N_0s) that computations should take on. "
    "The\n"
    "    default value is `200,400,600,...,4000`. Note that your command "
    "should not\n"
    "    contain `...`.\n"
    "--sample-num-array N11,N12,N13,N1n\n"
    "    An array of sample numbers (N_1) that computations should take on. "
    "The\n"
    "    default value is `10,20,...,250`. Note that your command should not "
    "contain\n"
    "    `...`.\n"
    "Options:\n"
